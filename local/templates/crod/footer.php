...
<? if (ERROR_404 != 'Y' && NEED_AUTH !== true): ?>
            ...
            <div class="footer-menu-wrap">
                ...
                <div class="actions-inner-wrap">
                    <div class="action-wrap">
                        <a href="<?= $pageVisible ?>" class="btn button-clear"
                           onclick='Cookies.set("bvi-panel-active",true,{path:"/",expires:1});'>
                    ...
                    <div class="action-wrap">
                        <a href="<? if ($USER->IsAuthorized()): ?>/personal/<? else: ?>/login/<? endif; ?>"
    ...
    <div class="popup-outer-box" id="popup-error">
        <div class="popup-box">
            <a href="" class="btn-action-ico ico-close js-popup-close"></a>
            <div class="popup-content-wrap">
                <div class="popup-title" data-error-text></div>
            </div>
        </div>
    </div>
