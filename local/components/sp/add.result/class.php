...
class AddResult extends CBitrixComponent  implements Controllerable
{
    private $ibRegion = 17;
    private $ibSubject = 9;
    private $ibYear = 24;
    private $ibFileResult = 30;
    private $errors = [];
    private $data = [];
    ...
    public function uploadAction()
    {
        ...
        foreach ($files as $key => $value)
        {
            ...
            $arLoadProductArray = Array(
                ...
                "PROPERTY_VALUES"=> [
                    'RESULT_FILE' => $value,
                    'RESULT_SECTION' => [$requestData['YEAR']],
                    'RESULT_REG' => $requestData['region'],
                    'RESULT_SUB' => $requestData['SUBJECT'],
                ],
